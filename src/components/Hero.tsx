...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen bg-gradient-primary flex items-center justify-center relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        <div className="animate-fade-in">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-lexend font-bold text-white mb-6 leading-tight">
            ...
            <br />
            <span className="text-primary-200">for a secure future</span>
          </h1>

          {/* Description */}
          <p className="text-xl md:text-2xl text-primary-100 mb-8 max-w-3xl mx-auto font-lexend">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Button 
              ...
              className="bg-white text-primary hover:bg-gray-100 font-lexend font-semibold px-8 py-3 text-lg transition-all duration-300 transform hover:scale-105"
            >
              Get Started
            </Button>
            <Button 
